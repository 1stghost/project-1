      ...
      <Pressable
        ...
        <View style={style.card}>
          <View style={style.iconContainer}>
            <Icon
              name="heart"
              color={car.liked ? COLORS.red : COLORS.primary}
            />
          </View>
          <Image
            source={car.image}
          ...
          <Text style={style.cardName}>{car.name}</Text>
          <View
            style={{
              marginTop: 5,
              flexDirection: 'row',
            ...
            <Text style={style.price}>{car.price}</Text>
  ...
  return (
    <SafeAreaView style={{backgroundColor: COLORS.white, flex: 1}}>
      ...
      <View style={style.header}>
        ...
        <Text style={style.headerTitle}>Your Home of Cars</Text>
        ...
        {/* Render To cars */}
        <Text style={style.title}>Top cars </Text>
